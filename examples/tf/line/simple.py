...
# ==============================================================================
'''
使用Galileo KerasTrainer和EstimatorTrainer训练LINE模型，简单用法
'''
...
class Inputs(g.BaseInputs):
    def __init__(self, **kwargs):
        ...
        self.train_transform = gt.EdgeNegTransform(**self.config).transform
        self.evaluate_transform = gt.NeighborNegTransform(
