...
# ==============================================================================
'''
Galileo训练unsupervised graphsage模型，使用hdfs路径，多卡训练
'''
...
hdfs_addr = 'hdfs://'
data_path = '/path/to/cora'
data_source_name = 'cora'
...
class SAGEEncode(nn.Module):
    def __init__(
        ...
        self.layer1 = gp.SAGELayer(output_dim,
                                   output_dim,
                                   aggregator_name,
                                   dropout_rate=dropout_rate)
...
class Inputs(g.BaseInputs):
    def __init__(self, **kwargs):
        ...
        self.transform = gp.MultiHopFeatureNegTransform(
